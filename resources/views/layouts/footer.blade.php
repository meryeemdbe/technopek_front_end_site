		...
		<section class="footer-top padding-y">
			<div class="row">
				<aside class="col-md-4">
					<article class="mr-3">
						<img src="../images/Technopek.png"  class="logo-footer">
						<p class="mt-3"> {{ __('Technopek team puts its expertise and passion for new technologies at the service of its clients') }}  {{ __('to help them develop their digital presence in a transparent manner') }}  </p>
						<div>
